...
echo "Total semua kursi di restoran adalah : $totalKursi <br>";
echo "Total kursi terpakai adalah: $kursiTerpakai <br>";
echo "Sisa kursi yang kosong di restoran adalah: $kursiKosong <br>";
